    ...
    <div>
      ...
      <div className="card form">
        ...
        <button
          ...
          disabled={isCreating || !name.trim() || !bodyTemplate.trim()}
        >
      ...
      {isLoading && <p className="loading">Loading templates...</p>}
            ...
            <tbody>
              {templates.map((template) => (
                <tr key={template.id}>
                  ...
                  <td>
                    <span className={`pill ${template.isActive ? "pill-success" : ""}`.trim()}>
                      {template.isActive ? "Yes" : "No"}
                    </span>
                  </td>
                  <td>
                    <button type="button" className="btn btn-sm" onClick={() => void handleToggleActive(template)}>
              ...
              {templates.length === 0 && (
                <tr>
                  <td colSpan={6} className="muted">No templates yet.</td>
                </tr>
              )}
            </tbody>
          </table>
